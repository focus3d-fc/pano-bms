...
public class WxPay {
    ...
    private WxSignTypeEnum signType;
    ...
    public WxPay(final WxPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox) throws Exception {
        ...
        this.signType = WxSignTypeEnum.MD5; // 只支持MD5
...
//        }
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        reqData.put("appid", "wxed31115f33aab720");//config.getAppID());
        reqData.put("mch_id", "1486464992");//config.getMchID());
        reqData.put("nonce_str", WxPayUtil.generateUUID());
        if (WxSignTypeEnum.MD5.equals(this.signType)) {
            reqData.put("sign_type", WxPayConstants.MD5);
        } else if (WxSignTypeEnum.HMACSHA256.equals(this.signType)) {
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        WxSignTypeEnum signType;
        if (signTypeInData == null) {
            signType = WxSignTypeEnum.MD5;
        } else {
            ...
            if (signTypeInData.length() == 0) {
                ...
                signType = WxSignTypeEnum.HMACSHA256;
            } else {
