...
public String toString() {
	return "User [id=" + id + ", nick_name=" + nick_name + ", name=" + name
			+ ", sex=" + sex + ", sex_str=" + sex_str + ", mobile=" + mobile
			+ ", status=" + status + ", status_str=" + status_str + ", city="
			+ city + ", email=" + email + ", cert_no=" + cert_no
			+ ", role_name=" + role_name + ", head_img_sn=" + head_img_sn
			+ ", is_allocate_space=" + is_allocate_space + ", wx_id=" + wx_id
			+ ", adder_sn=" + adder_sn + ", adder_name=" + adder_name
			+ ", add_time=" + add_time + ", updater_sn=" + updater_sn
			+ ", updater_name=" + updater_name + ", update_time=" + update_time
	...
	public User(long id, String nick_name, String name, int sex,
			String sex_str, String mobile, int status, String status_str,
			String city, String email, String cert_no, String role_name,
			long head_img_sn, int is_allocate_space, String wx_id,
			long adder_sn, String adder_name, String add_time, long updater_sn,
			String updater_name, String update_time, int startIndex,
			int pagesize) {
		super();
		this.id = id;
		this.nick_name = nick_name;
