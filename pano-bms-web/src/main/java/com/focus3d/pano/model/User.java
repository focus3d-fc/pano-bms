...
public class User implements Serializable,CommonModel{
	...
	private long sn;//1.主键，用户id--------------后台用户表
	...
	public User(long sn, String nick_name, String name, int sex,
