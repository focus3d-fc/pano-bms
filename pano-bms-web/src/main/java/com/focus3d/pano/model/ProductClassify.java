...
public class ProductClassify implements Serializable, CommonModel{
	...
	public String toString() {
		return "PanoProductType [sn=" + sn + ", name=" + name + ", status="
				...
				+ ", getSn()=" + getSn() + ", getName()=" + getName()
				+ ", getStatus()=" + getStatus() + ", getAdderSn()="
				+ getAdderSn() + ", getAdderName()=" + getAdderName()
				+ ", getAddTime()=" + getAddTime() + ", getUpdaterSn()="
				+ getUpdaterSn() + ", getUpdaterName()=" + getUpdaterName()
				+ ", getUpdateTime()=" + getUpdateTime() + ", getEncryptSn()="
				+ getEncryptSn() + ", getClass()=" + getClass()
