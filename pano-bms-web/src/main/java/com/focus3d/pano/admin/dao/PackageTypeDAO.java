...
public interface PackageTypeDAO {
		...
		public List<ProductList> getProductList(Map<String, Object> map); // 显示所有产品数值 模糊查询 和 分页
		...
		public List<GetproductList> getListProduct(GetproductList list); //用于展示分类下产品的固定值
		
		public List<Product> getProductSn(Long sn);   //查看和产品关联的风格 类型 功能SN数据
		
		public List<GetproductList> GetMap(Map map);   //查询 分类下的产品在关联的数据
